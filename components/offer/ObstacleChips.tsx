        ...
        {chips.map((chip) => {
          ...
          return (
            <button
              ...
              className={cn(
                "min-h-11 max-w-full touch-manipulation whitespace-normal rounded-full border px-4 py-2.5 text-center text-sm font-semibold leading-snug transition-all duration-300 sm:px-5",
                isSelected
